...
class PdfDisplay extends ConsumerStatefulWidget {
  ...
  @override
  PdfDisplayState createState() => PdfDisplayState();
}

class PdfDisplayState extends ConsumerState<PdfDisplay>
    ...
    return Scaffold(
      ...
      body: Theme(
        data: ThemeData(
          ...
          primaryIconTheme: const IconThemeData(color: Pallete.primaryColor),
        ),
        child: Center(
          child: SizedBox(
            height: widget.useMobileLayout
            ...
            child: PdfPreview(
              ...
              useActions: false,
              maxPageWidth: widget.useMobileLayout
                  ? null
              ...
              build: (format) =>
                  generateDocument(context, pdfModel: _pdfProvider),
            ),
          ),
        ),
      ),
