...
class UserInformation extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final isPicNull = profilePic == null;
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    return Container(
      ...
      child: Padding(
        ...
        child: ref.watch(resumeController(user.uid)).when(
          data: (resumes) {
            return Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
        ...
        child: Row(
          children: [
            Column(
              ...
              children: [
                Text(
                  pdfModel.resumePersonal!.firstName!,
                  style: subtitle14.copyWith(
                ...
                Text(
                  'Last saved ${timeAgoSinceDate(pdfModel.lastUpdated)}',
            ...
            SimpleOutlinedButton(
              color: Pallete.primaryColor,
              onPressed: () async {
                await Get.toNamed<void>('/resume/${pdfModel.pdfId}');
              },
              text: 'Edit',
            ),
          ],
