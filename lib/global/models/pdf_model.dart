...
class PdfModel with _$PdfModel {
  ...
  const factory PdfModel({
    ...
    @JsonKey(defaultValue: <Section>[]) List<Section>? employment,
    @JsonKey(defaultValue: <Section>[]) List<Section>? education,
    @JsonKey(defaultValue: <Section>[]) List<Section>? activities,
    @JsonKey(defaultValue: <Skill>[]) List<Skill>? languages,
    @JsonKey(defaultValue: <Skill>[]) List<Skill>? skills,
    @JsonKey(defaultValue: <Skill>[]) List<Skill>? hobbies,
    @JsonKey(defaultValue: <Links>[]) List<Links>? links,
